...
Redeveloped by <a href="https://" rel="dofollow" target="_blank">LTI</a> - <a href="" rel="dofollow" target="_blank"></a>
...
if($mod=='karyawan' OR $mod =='jabatan' OR $mod=='shift' OR $mod=='lokasi' OR $mod=='user' OR $mod=='absensi' OR $mod=='cuty' OR $mod=='absensi-flexible'){
echo'
