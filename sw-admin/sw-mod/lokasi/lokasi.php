              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <input class="form-control" id="Latitude" placeholder="Latitude" name="latitude" readonly required>
                      </div>

                      <div class="col-lg-6">
                        <input class="form-control" id="Longitude" placeholder="Longitude" name="longitude" readonly required>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <input class="form-control" id="Latitude" placeholder="Latitude" name="latitude" value="'.$location[0].'" readonly required>
                      </div>

                      <div class="col-lg-6">
                        <input class="form-control" id="Longitude" placeholder="Longitude" name="longitude" value="'.$location[1].'" readonly required>
                      </div>
                    </div>
                  </div>
                </div>
